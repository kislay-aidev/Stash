# here, added more folders in the skipped list.

# currently skip these folders:
# Documents
# Images
# Videos
# Music
...
# But later added these folder to be created during the scanning process 
# Project
# WebPages
# Others
# GIFs
# These are NOT being skipped.
...
# So update the folder skipping list adding in these folder:
# foldernames[:] = [
#     f for f in foldernames
#     if f not in ["Documents","Images","Videos","Music","Archives","Project","WebPages","Others","GIFs"]
# ]
