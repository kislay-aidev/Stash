# In previous version, there were no log tags for the files, like:
# [MOVED] - for moving files, 
# [DUPLICATE] - if a duplicate file is moved, 
# [ERROR] - encountered, if any,
#  [UNKNOWN] - if found files with unknoun extensions.

# adding log tags like these makes logs much more scannable when they grow large.

# Log style in previous versions:
# Moved: Welcome Class.pdf from FileOrgProject to PDFs

# Improved log style:
# [MOVED] Welcome Class.pdf | FileOrgProject -> PDFs
# [DUPLICATE] Report.docx -> Report(1).docx | Downloads -> Word Docs
# [ERROR] Failed to move data.csv | Temp -> CSV Files | Permission denied
# [UNKNOWN] abc.xyz | Misc -> Others/Unknown
