# added "Run Time" parameter inside the "stats" dictionsry. 
# Now, the statistics.json will have the runtime, when the main file is run.
# it will look something like this, the "Statistics.json" :
# {
#   "Run Time": "2026-06-24 19:46:34",
#   "Files Processed": 9,
#   "Files Moved": 9,
...
# where, Run time is at the top in json file.
