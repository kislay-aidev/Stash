# The stats logic was broken.

# First, the stats dictionary, and its variables:
# files_processed, files_moved, unknown_files, duplicates_renamed
# all of them were written as normal global variables, which can't be used inside any function

# to use those variables and update stats dictionary,
# used keyword "global" with all the variables inside the
# def safe_move() function.

# By this addition, now, the variables can be used inside that function and the stats dictionary can be updated.

# Second, the variable counter: files_processed, was not being incremented
# after a successful moveing of files or after renaming the duplicates
# Also, the updated/incremented counter variables, whenever they were being incremented,
# were not being updated inside the stats dictionary

# so, added the update script:
...
# All these lines are now added whenever, the dictionary variables are incremented.
