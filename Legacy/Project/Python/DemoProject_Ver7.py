# Here, Used os.makedirs(..., exist_ok=True) so it won’t error if the folder already exists.
# Also used the Shutil module for "shutil.move()" method for moving of files, rather than using the "os.rename" method.
