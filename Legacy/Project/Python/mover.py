"""
Stash — File mover with safe duplicate handling.

Moves files to their target destinations and delegates duplicate naming
to DuplicateResolver. Every operation is logged via StashLogger and tracked
via StatsTracker.
"""
...
from core.duplicate_handler import DuplicateResolver
