# Added the logic for creating a 'Statistics.json" file 
# for having the stats/details about files processed, files moved, etc.

# To store the stats file, created a "stats" folder inside the ".system" folder.
# Note: the ".system" folder is an internal folder which contains files,
# generated by the application/software for keeping the records.
