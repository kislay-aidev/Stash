# in previous version (ver 31),
# after having the category count, it was not showing in the final stats file (json).
# this was because of this line:

# adding category counts to "stats"
# stats["Category Counts"] = category_counts

# but, after creating the json file from the stats dict:
...
# This way, even after having the category counter, 
# it was not showing in the actual file.
# Since, the key was being updated after 
# when, the json file has been created.
# So, fixed the key updating task before creating the json file:
