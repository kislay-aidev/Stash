# In previous version, the stats counters like
# documents_renamed, fiiles_processed, files_moved, etc.
# they were incremented, but their updated value was not stored bake in "stats" dictionary.

# So, written :
# stats["Files Processed"] = files_processed, and others
# immediately after, when the counter was incremented

# documents_renamed += 1
# stats["Documents Renamed"] = documents_renamed
