...
class DirectoryScanner:
    ...
    def scan(self) -> Generator[Tuple[str, str, str], None, None]:
        ...
        revisited. Files listed in *skip_files* are skipped when
        encountered at the project root.
        """
        for current_path, foldernames, filenames in os.walk(self.project_folder):
            ...
            for filename in filenames:
                if current_path == self.project_folder and filename in self.skip_files:
                    continue
